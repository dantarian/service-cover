...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { engineer_id: @assignment.engineer_id, service_id: @assignment.service_id } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { engineer_id: @assignment.engineer_id, service_id: @assignment.service_id } }
