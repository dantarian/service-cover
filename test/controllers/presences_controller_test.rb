...
class PresencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presence" do
    assert_difference('Presence.count') do
      post presences_url, params: { presence: { engineer_id: @presence.engineer_id, status: @presence.status, working_date: @presence.working_date } }
    end
  ...
  test "should update presence" do
    patch presence_url(@presence), params: { presence: { engineer_id: @presence.engineer_id, status: @presence.status, working_date: @presence.working_date } }
